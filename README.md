# 🚀 ogie - Simple OpenGraph Metadata Extraction Tool

🛠️ Extract OpenGraph and metadata with ease.
...
- [How to Use ogie](#how-to-use-ogie)
- [Support](#support)
...
- **Easy Extraction**: Quickly pull OpenGraph and metadata from websites.
...
3. **View the Output**: After running the command, ogie will show you the extracted metadata directly in your terminal. You can then use this information as needed.
